export default function injectSwupStyles(): string {
  ...
  */
  html[data-fragment-visit="replaceCharacters"] .transition-teaser {
    transition-property: opacity, transform;
    transition-duration: 450ms;
  }
  html[data-fragment-visit="replaceCharacters"].is-animating
    .transition-teaser {
    opacity: 0;
    transform: scale(0.75);
  }
  html[data-fragment-visit="replaceCharacters"].is-leaving .transition-teaser {
    transition-duration: 100ms;
  }

  /*
  * The transition for the overlay
  */
  ...
  * The transition between characters
  */
  html[data-fragment-visit="replaceCharacter"] .transition-character {
    transition: opacity 200ms, transform 200ms;
  }
  html[data-fragment-visit="replaceCharacter"].is-animating
    .transition-character {
    opacity: 0;
    transform: translateY(-20px);
  }
  html[data-fragment-visit="replaceCharacter"].is-leaving
    .transition-character {
    opacity: 0;
    transform: translateY(20px);
  }
