...
```astro title="/character/luigi/index.html" 'data-link-to-fragment="#list"' 'data-swup-fragment-url="/characters/"'
<main id="overlay">
...
```html 'data-link-to-fragment="#list"'
