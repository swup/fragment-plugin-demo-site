...
detect that fact, so it would replace the list upon closing the modal.
...
to the matching fragment's fragment URL. This is in use for the modal close buttons on this site:
...
+ <dialog open id="character-modal" aria-role="article">
    <main>
      <h1>User 1</h1>
      <p>Lorem ipsum dolor...</p>
    </main>
